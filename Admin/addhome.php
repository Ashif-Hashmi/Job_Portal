...
<form class="user" method="post" action="Crud_home.php" enctype="multipart/form-data">
                             <div class="form-group row">
                              ...
                              <?php
                                $proid="";
                                $query=mysqli_query($con,"select * from home_setting order by Id desc limit 1 ");
                                ...
                                <div class="form-group row" >
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" name="Subheading" class="form-control" placeholder="Sub Heading">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control "
                                            id="exampleRepeatPassword" name="Categoryname" placeholder="Category Name" required >
                                    </div>
                                  
                                </div>  
                                <button type="submit" class="btn btn-danger btn-user btn-block" name="btnhome">
                                  Add Worker
                                </button>
                                <hr>
